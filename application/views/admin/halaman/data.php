...
<div class="box">
                                ...
                                <?php
                                echo anchor('admin/halaman/post','Input Halaman Statis',array('class'=>'btn btn-primary btn-sm'))
                                ?>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($record as $r){
                                                echo "<tr>
                                                      ...
                                                      </td><td width='10'>".anchor("admin/halaman/edit/".$r->pages_id,"<span class='glyphicon glyphicon-tags' aria-hidden='true'></span>",array('title'=>'edit data'))."</td>

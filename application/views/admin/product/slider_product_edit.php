			...
			<table class="table">
				...
				?>
					<tr>
						...
						<td>
							<div class="col-sm-12">
								<input type="text" value="<?php echo $product_slider['nama_slider'];?>" class="form-control" id="form-field-1" placeholder="* Slider Name" name="nama_slider" required />
							</div>
						</td>
					</tr>
								...
								<select name="nama_product_seo" class="form-control search-select" id="form-field-2" placeholder="* Link Product" required>
									<?php
										foreach ($link_product as $lp){
											echo "<option value='$lp->nama_product_seo' ";
											echo $lp->nama_product_seo==$product_slider['nama_product_seo']?'selected':'';
											echo ">$lp->nama_product</option>";
										}
									?>
								</select>
							</div>

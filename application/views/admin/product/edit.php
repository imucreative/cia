<div class="col-sm-12">
		...
		<div class="panel-body">
			<div class="tabbable panel-tabs">
				<ul class="nav nav-tabs">
					...
					<li><a data-toggle="tab" href="#panel2"><i class="clip-tag"></i> Tags</a></li>
						...
						<table class="table">
							...
							?>
								...
								<tr>
									...
									<td>
										<div class="col-sm-12">
											<select name="kategori" class="form-control search-select" id="form-field-3" placeholder="* Category" required>
												<?php
								...
								<tr>
									<td align='right' width='20%'>
										<label class="col-sm-12 control-label" for="form-field-4">QUALITY :</label>
									</td>
									<td>
										<div class="col-sm-12">
											<input value="<?php echo $row['kualitas'];?>" type="text" class="form-control" id="form-field-4" placeholder="* Product Quality" name="kualitas" required />
										</div>
									</td>
								</tr>
						...
						<table id="mytable" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th width='80%'><center>TAGS</center></th>
								...
								<?php
									...
									foreach ($product_tags as $pt){
										echo "<tr>
											...
											<td width='80%'>".get_tag('tags', $pt->id_tags)."</td>
											<td width='10%' align='center'>".
												
												anchor("admin/product/delete_tag_produk/".$row['product_id']."/".$pt->product_tags_id, '<i class="fa fa-trash-o"></i> Delete', ["class"=>"btn btn-xs btn-danger tooltips", "data-placement"=>'top', "data-original-title"=>'Delete', "title"=>'Delete', "onclick"=>"return confirm('Are you sure?')"])
	...
	<div id="modal_input" class="modal fade" tabindex="-1" data-focus-on="input:first" style="display: none;">
		<?php 
			echo form_open('admin/product/post_tag_produk');
			echo form_hidden('product_id', $row['product_id']);
		?>
		
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h4 class="modal-title"><i class='clip-tag'></i> Input Tags</h4>
		</div>
		<div class="modal-body">
			<div class="row">
				<div class="col-md-12">
					<select name="tags" class="form-control search-select" required>
						<?php
							foreach ($tags as $t){
								echo "<option value='$t->id_tags'>$t->tags</option>";
							}
						?>
					</select>
				</div>

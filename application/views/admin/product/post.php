			...
			<table class="table">
				...
				?>
					...
					<tr>
						...
						<td>
							<div class="col-sm-12">
								<input type="text" class="form-control" id="form-field-4" placeholder="* Product Quality" name="kualitas" required />
							</div>
						</td>
					</tr>
					...
					<tr>
						<td align='right' width='20%'>
							<label class="col-sm-12 control-label" for="form-field-5">TAGS :</label>
						</td>
						<td>
							<div class="col-sm-12">
								<select multiple="multiple" name="tags[]" class="form-control search-select" id="form-field-5" placeholder="* Tags" required>
									<?php
										foreach ($tags as $t){

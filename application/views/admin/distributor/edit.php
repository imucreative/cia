<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-external-link-square"></i>Form Edit Master Distributor
        ...
        <div class="panel-body">
			<table class="table">
				<?php
					echo form_open_multipart('admin/distributor/edit');
					echo form_hidden('distributor_id', $row['distributor_id']);
				?>
					<tr>
						...
						<td>
							<div class="col-sm-12">
								<input type="text" value="<?php echo $row['nama_distributor']?>" class="form-control" id="form-field-1" placeholder="* Distributor" name="nama_distributor" required />
							</div>
						</td>
					</tr>
							...
							<div class="col-sm-12">
								...
								<?php
									if(empty($row['image'])){
										...
										echo "<img title='".$row['nama_distributor']."' width='200' src='".base_url()."/uploads/distributor/".$row['image']."'>";
									}
								?>
